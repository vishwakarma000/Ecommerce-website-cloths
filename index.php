...
<html lang="en">
  ...
  <a class="btn btn-dark me-md-2 mb-1" href="signup.php" type="button">Signup</a>
  <a class="btn btn-dark me-md-2 mb-1"  href="adminlogin.php" type="button">Admin</a>
</div>
  </div>
</nav>    
  ...
  <div class="row px-4">
    ...
    <div class="col-md-3 mb-3">
      ...
      <select class="form-select mb-3" aria-label="Default select example">
        ...
        <option value="Jeyseys">Jeyseys</option>
